...
const ToastItem: React.FC<{ toast: Toast; onClose: () => void }> = ({ toast, onClose }) => {
  ...
  const colors = {
    success: 'border-success-200 bg-success-50 dark:border-success-800 dark:bg-success-900/50',
    error: 'border-error-200 bg-error-50 dark:border-error-800 dark:bg-error-900/50',
    warning: 'border-warning-200 bg-warning-50 dark:border-warning-800 dark:bg-warning-900/50',
    info: 'border-info-200 bg-info-50 dark:border-info-800 dark:bg-info-900/50'
  };

  return (
    <div
      className={`pointer-events-auto flex items-start gap-3 p-4 rounded-xl border shadow-lg backdrop-blur-xl ${colors[toast.type]} toast-slide-in`}
